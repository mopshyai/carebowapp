      ...
      >
        <View style={styles.infoCard}>
          ...
          <Text style={styles.infoText}>
            CareBow separates account security from access to each health profile. Profile sharing
            is granted and revoked per person so one global switch cannot silently override explicit
            access.
          </Text>
        </View>
