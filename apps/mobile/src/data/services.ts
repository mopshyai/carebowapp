 ...
 * Local service catalog (pre-migration data, restored) + pure pricing/booking utilities.
 *
 * NOTE: Prices are authored in a USD base; a separate country-pricing layer handles
 * currency/locale display conversion. Do not scale or convert prices here.
 */
...
const commonBenefits = {
  certifiedCare: {
    ...
    description:
      'All our caregivers are trained and certified professionals with extensive experience.',
  },
  backgroundVerified: {
    title: 'Background-Verified Staff',
    description:
      'Every staff member undergoes thorough background verification for your peace of mind.',
  },
  friendly: {
...
const companionshipService: Service = {
  ...
  description:
    'Our companionship service provides meaningful social interaction and emotional support for seniors. Our trained companions engage in conversations, accompany on walks, assist with hobbies, and provide the human connection that enhances quality of life.',
  benefits: [
...
const transportService: Service = {
  ...
  description:
    "Our transportation service ensures safe, comfortable, and reliable travel for seniors. Whether it's a doctor's appointment, shopping trip, or social visit, our trained drivers provide door-to-door service.",
  benefits: [
    commonBenefits.backgroundVerified,
    commonBenefits.friendly,
    commonBenefits.flexibleScheduling,
...
const expertNurseService: Service = {
  ...
  description:
    'Our Expert Home Stay Nurse service provides qualified nursing professionals who deliver medical care in the comfort of your home. From medication management and vital sign monitoring to wound care and post-operative support.',
  benefits: [
    commonBenefits.certifiedCare,
    commonBenefits.backgroundVerified,
  ...
  request: {
    ...
    required: true,
    placeholder:
      'Please describe the patient condition, required care level, and any medical history we should know...',
  },
};
...
const culturaspireService: Service = {
  ...
  description:
    'Culturaspire brings enriching cultural experiences to seniors. From music sessions and art classes to book clubs and cultural discussions, we help seniors stay mentally active and socially engaged.',
  benefits: [
    {
  ...
  request: {
    ...
    required: true,
    placeholder:
      "Tell us about your interests - music, art, literature, languages, or other cultural activities you'd like to explore...",
  },
};
...
const gourmetFoodService: Service = {
  ...
  description:
    'Our gourmet food service provides nutritionally balanced, delicious meals tailored to senior dietary needs. Our expert nutritionists design menus that accommodate health conditions.',
  benefits: [
    {
  ...
  request: {
    ...
    required: true,
    placeholder:
      'Please describe dietary requirements, allergies, preferred cuisine, and any health conditions...',
  },
};
...
const doctorVisitService: Service = {
  ...
  description:
    'Our Doctor Visit service brings qualified physicians to your home for consultations, check-ups, and follow-up visits. Skip the hassle of hospital queues.',
  benefits: [
    commonBenefits.certifiedCare,
    commonBenefits.atHome,
    commonBenefits.flexibleScheduling,
...
const labTestingService: Service = {
  ...
  description:
    'Our lab testing service provides convenient home sample collection for a wide range of diagnostic tests. Our trained phlebotomists ensure comfortable sample collection.',
  benefits: [
    commonBenefits.certifiedCare,
    commonBenefits.atHome,
    {
...
const physiotherapyService: Service = {
  ...
  description:
    'Our physiotherapy service brings qualified therapists to your home for rehabilitation, pain management, and mobility improvement.',
  benefits: [
    commonBenefits.certifiedCare,
    commonBenefits.atHome,
    {
  ...
  request: {
    ...
    required: true,
    placeholder:
      'Please describe the condition requiring therapy, any previous treatments, and your goals...',
  },
};
...
const healthCheckService: Service = {
  ...
  description:
    'Our HealthCheck Visit service provides thorough health assessments conducted at your home. Our medical team evaluates vital signs, reviews medications, and provides recommendations.',
  benefits: [
    commonBenefits.certifiedCare,
    commonBenefits.atHome,
    {
  ...
  request: {
    ...
    required: true,
    placeholder:
      'Please describe any specific health concerns, current medications, and areas to focus on...',
  },
};
...
const deepCleaningService: Service = {
  ...
  description:
    'Our deep-cleaning service goes beyond regular cleaning to ensure a spotless, hygienic living environment. We use senior-safe, eco-friendly products.',
  benefits: [
    {
...
const yogaService: Service = {
  ...
  description:
    'Our yoga and meditation service offers gentle, age-appropriate practices designed specifically for seniors. Our certified instructors focus on improving flexibility, balance, and mental well-being.',
  benefits: [
    commonBenefits.certifiedCare,
    commonBenefits.atHome,
    commonBenefits.flexibleScheduling,
  ...
  request: {
    ...
    required: false,
    placeholder:
      'Any physical limitations or specific focus areas (flexibility, stress relief, etc.)...',
  },
};
...
const barberService: Service = {
  ...
  description:
    'Our at-home barber service brings professional grooming right to your door. Our experienced barbers are trained to work with seniors.',
  benefits: [
    commonBenefits.certifiedCare,
    commonBenefits.backgroundVerified,
    commonBenefits.atHome,
...
const transactionalCareService: Service = {
  ...
  description:
    'Quick, one-time medical care services for immediate needs. Our trained professionals provide essential care support when you need it most.',
  benefits: [
    commonBenefits.certifiedCare,
    commonBenefits.backgroundVerified,
    commonBenefits.atHome,
...
const cardiacPackageService: Service = {
  ...
  description:
    'Complete cardiac health monitoring and care package including ECG, heart health checkup, medication management, and regular follow-ups.',
  benefits: [commonBenefits.certifiedCare, commonBenefits.atHome, commonBenefits.support247],
  fulfillment: { mode: 'checkout', requiresPayment: true },
...
const oncologyPackageService: Service = {
  ...
  description:
    'Comprehensive oncology care package with specialized nursing, medication management, pain management support, and emotional care.',
  benefits: [commonBenefits.certifiedCare, commonBenefits.atHome, commonBenefits.support247],
  fulfillment: { mode: 'checkout', requiresPayment: true },
...
const neuroPackageService: Service = {
  ...
  description:
    'Specialized neurological care package including cognitive assessments, rehabilitation exercises, and ongoing monitoring.',
  benefits: [commonBenefits.certifiedCare, commonBenefits.atHome, commonBenefits.support247],
  fulfillment: { mode: 'checkout', requiresPayment: true },
...
const cardiacBasicService: Service = {
  ...
  benefits: [commonBenefits.certifiedCare, commonBenefits.atHome],
  fulfillment: { mode: 'checkout', requiresPayment: true },
...
const orthoPackageService: Service = {
  ...
  description:
    'Complete orthopedic care package including mobility assessment, physiotherapy, and pain management.',
  benefits: [
    commonBenefits.certifiedCare,
    commonBenefits.atHome,
    commonBenefits.flexibleScheduling,
...
const oxygenConcentratorService: Service = {
  ...
  description:
    'Rent medical-grade oxygen concentrators for home use with setup assistance and 24/7 technical support.',
  benefits: [
    commonBenefits.atHome,
    commonBenefits.support247,
...
const bpapService: Service = {
  ...
  description:
    'BPAP machine rental for respiratory support with professional setup and monitoring.',
  benefits: [commonBenefits.atHome, commonBenefits.support247],
  fulfillment: { mode: 'checkout', requiresPayment: true },
  pricing: {
    type: 'packages',
    packages: [
...
const medicalCotTwoService: Service = {
  ...
  description:
    'Two-function medical cot with adjustable head and leg positions for enhanced comfort.',
  benefits: [
    commonBenefits.atHome,
    { title: 'Delivery & Setup', description: 'Free delivery and professional setup included.' },
  ],
...
const alfaBedService: Service = {
  ...
  description:
    'Premium Alfa bed with multiple adjustable positions, side rails, and IV pole attachment.',
  benefits: [
    commonBenefits.atHome,
    commonBenefits.support247,
...
const medicineDeliveryService: Service = {
  ...
  description:
    'Fast and reliable medicine delivery service. Upload prescription and get medicines delivered to your doorstep.',
  benefits: [
    commonBenefits.atHome,
...
export function getCategoryByServiceId(serviceId: string): ServiceCategory | undefined {
  return serviceCategories.find((category) => category.items.some((item) => item.id === serviceId));
}
